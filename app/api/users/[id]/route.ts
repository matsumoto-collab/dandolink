...
export async function PATCH(req: NextRequest, context: RouteContext) {
    try {
        ...
        const { email, displayName, password, role, assignedProjects, isActive, dailyRate, companyId, isLoginEnabled, partnerTaxMode, canAccessCashbook, tentativeConfirmLeadDays } = validation.data;
        ...
        if (canAccessCashbook !== undefined) updateData.canAccessCashbook = canAccessCashbook;
        if (tentativeConfirmLeadDays !== undefined) updateData.tentativeConfirmLeadDays = tentativeConfirmLeadDays;
