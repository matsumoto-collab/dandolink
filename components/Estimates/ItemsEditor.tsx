...
function CategoryTableRow({
    ...
    return (
        <tr id={`estimate-item-${item.id}`} ref={sortableRef} style={sortableStyle} {...(sortableAttributes || {})} className="border-b border-slate-200 bg-slate-50">
            ...
            <td className="px-3 py-2 sticky z-10 bg-slate-50" style={{ left: 32, minWidth: 80, maxWidth: 80, width: 80 }}>
            ...
            <td className="px-3 py-2 sticky z-10 bg-slate-50 border-r border-slate-300" style={{ left: 112, minWidth: 320, width: 320 }}>
...
export default function ItemsEditor({
    ...
    return (
        <div>
            ...
            <div className="hidden lg:block border border-slate-200 rounded-lg overflow-auto max-h-[460px]">
                <table className="min-w-[1900px]">
                    <thead className="bg-slate-50 border-b border-slate-200 sticky top-0 z-10">
                        <tr>
                            <th className="sticky left-0 z-20 bg-slate-50" style={{ minWidth: 32, maxWidth: 32, width: 32 }}></th>
                            <th className="px-3 py-2 text-center text-xs font-semibold text-slate-600 sticky z-20 bg-slate-50" style={{ left: 32, minWidth: 80, maxWidth: 80, width: 80 }}>操作</th>
                            <th className="px-3 py-2 text-left text-xs font-semibold text-slate-600 sticky z-20 bg-slate-50 border-r border-slate-300" style={{ left: 112, minWidth: 320, width: 320 }}>項目</th>
