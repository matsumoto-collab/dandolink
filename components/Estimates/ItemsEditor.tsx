...
function CategoryTableRow({
    ...
    return (
        <tr ref={sortableRef} style={sortableStyle} {...(sortableAttributes || {})} className="border-b border-slate-200 bg-slate-50">
            {dragListeners && (
                <td className="px-1 py-2 w-8 sticky left-0 z-10 bg-slate-50">
            ...
            <td className="px-3 py-2 sticky left-[32px] z-10 bg-slate-50">
            ...
            <td className="px-3 py-2 sticky left-[112px] z-10 bg-slate-50 border-r border-slate-300">
            ...
            <div className="hidden lg:block border border-slate-200 rounded-lg overflow-auto max-h-[220px]">
                <table className="min-w-[1900px]">
                    <thead className="bg-slate-50 border-b border-slate-200 sticky top-0 z-10">
                        <tr>
                            <th className="w-8 sticky left-0 z-20 bg-slate-50"></th>
                            <th className="px-3 py-2 text-center text-xs font-semibold text-slate-600 w-20 sticky left-[32px] z-20 bg-slate-50">操作</th>
                            <th className="px-3 py-2 text-left text-xs font-semibold text-slate-600 w-80 sticky left-[112px] z-20 bg-slate-50 border-r border-slate-300">項目</th>
