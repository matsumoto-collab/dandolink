...
export default function ProjectSearchModal({
    ...
    return (
        <div className="fixed inset-0 lg:left-48 bg-black bg-opacity-50 flex items-start pt-[4rem] pwa-modal-offset-safe lg:items-center lg:pt-0 justify-center z-[60]">
