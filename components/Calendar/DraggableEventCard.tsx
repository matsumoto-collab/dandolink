...
export default function DraggableEventCard({
    ...
    return (
        <div
            ...
            className={`
        mb-1 p-0.5 xl:p-1 rounded-lg
        transition-colors duration-150
        text-[10px] xl:text-[11px] relative overflow-hidden
                        ...
                        >
                            ...
                            <div className="flex items-center gap-1 mt-0.5 text-slate-700 whitespace-nowrap">
                                ...
                                {event.estimatedHours != null && (
                                    <>
                                        {(event.memberCount ?? 0) > 0 && <span className="text-slate-500">|</span>}
                                        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            {event.remarks && (
                                <div className="flex items-start gap-1 mt-0.5 text-slate-700">
                                    ...
                                    <span className="truncate text-[10px] xl:text-[11px]">{event.remarks}</span>
                                </div>
                            )}
                        </div>
