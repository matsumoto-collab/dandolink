    ...
    return (
        <div className="flex border-b-2 border-slate-300 bg-teal-50 shadow-sm h-auto min-h-[56px]">
            ...
            <div className="sticky left-0 z-30 bg-teal-50 border-r-2 border-slate-300 shadow-md">
                <div className="w-20 lg:w-24 xl:w-32 h-full flex items-center justify-center py-2">
            ...
            {weekDays.map((day, index) => {
                ...
                return (
                    <div
                        key={index}
                        className={`
                            flex-1 min-w-[88px] lg:min-w-[100px] xl:min-w-[140px] border-r border-slate-200 p-1.5
