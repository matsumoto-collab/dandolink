                ...
                <div className="flex-1 min-w-0 px-4 py-3">
                    ...
                    <div className="flex items-center gap-1.5 mb-1.5 flex-wrap">
                        ...
                        {constructionTypeInfo && (
                            <span
                                className="inline-flex items-center text-[11px] font-medium text-slate-900 px-2 py-0.5 rounded-full"
                                style={{
...
function QuickEditSheet({ project, onSave, onClose }: QuickEditSheetProps) {
    ...
    return (
        <>
            ...
            <div className="fixed bottom-0 left-0 right-0 lg:left-48 bg-white rounded-t-2xl shadow-2xl z-[70] animate-slide-up safe-area-bottom">
