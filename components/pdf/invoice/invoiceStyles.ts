...
export const invoiceStyles = StyleSheet.create({
    ...
    tableRow: { flexDirection: 'row', borderBottomWidth: 0.5, borderBottomColor: COLORS.borderMedium, minHeight: 20 },
    tableRowLast: { flexDirection: 'row', borderBottomWidth: 0.5, borderBottomColor: COLORS.borderMedium, minHeight: 20 },
    projectHeaderRow: { flexDirection: 'row', borderBottomWidth: 0.3, borderBottomColor: COLORS.borderLight, minHeight: 20 },
